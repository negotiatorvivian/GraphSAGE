...
flags.DEFINE_integer('epochs', 100, 'number of epochs to train.')  # 1
flags.DEFINE_float('dropout', 0.2, 'dropout rate (1 - keep probability).')   # 0.0
flags.DEFINE_float('weight_decay', 0.000000001, 'weight for l2 loss on embedding matrix.')
flags.DEFINE_integer('max_degree', 300, 'maximum node degree.')
flags.DEFINE_integer('samples_1', 250, 'number of samples in layer 1')
flags.DEFINE_integer('samples_2', 100, 'number of users samples in layer 2')
flags.DEFINE_integer('dim_1', 128, 'Size of output dim (final is 2x this, if using concat)')
flags.DEFINE_integer('dim_2', 128, 'Size of output dim (final is 2x this, if using concat)')
flags.DEFINE_boolean('random_context', True, 'Whether to use random context or direct edges')
flags.DEFINE_integer('neg_sample_size', 100, 'number of negative samples default 20')
flags.DEFINE_integer('batch_size', 1280, 'minibatch size. default 512')
flags.DEFINE_integer('n2v_test_epochs', 1, 'Number of new SGD epochs for n2v.')
flags.DEFINE_integer('identity_dim', 2,
...
flags.DEFINE_integer('validate_batch_size', 256, "how many nodes per validation sample. default 256")
