...
flags.DEFINE_string('base_log_dir', 'log', 'base directory for logging and saving embeddings')
...
def train(train_data, test_data = None):
    ...
    np_node_embeddings = tf.get_default_graph().get_tensor_by_name("node_embeddings:0")
    np_node_embeddings = sess.run(np_node_embeddings)
    np.savez(os.path.join(FLAGS.base_log_dir, "node_embeddings.npz"), np_node_embeddings)
